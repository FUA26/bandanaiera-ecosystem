...
const priorityColors: Record<string, string> = {
  ...
  HIGH: "bg-secondary/15 text-secondary border-secondary/30",
...
export function KanbanCard({ task, onClick }: KanbanCardProps) {
  ...
  return (
    <div ref={setNodeRef} style={style} className="group relative">
      <Card
        className={`cursor-pointer border-l-4 p-3 transition-all hover:shadow-md ${priorityBorderColors[task.priority] || "border-l-transparent"} ${isDragging ? "shadow-lg" : ""} `}
