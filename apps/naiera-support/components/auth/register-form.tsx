    ...
    return (
      <div className="flex animate-in flex-col items-center justify-center space-y-4 py-8 text-center duration-700 fade-in slide-in-from-bottom-4">
        ...
        <div className="w-full space-y-4 pt-4">
          ...
          <Button
            asChild
            className="mt-6 h-11 w-full rounded-xl bg-primary font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90"
          >
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
      ...
      <p className="pt-2 text-center text-sm">
        <span className="mr-1 text-muted-foreground">Sudah punya akun?</span>
        <Link
          href="/login"
          className="font-semibold text-primary transition-colors hover:text-primary/80"
        >
          Masuk di sini{" "}
          <ArrowRight className="mb-0.5 ml-0.5 inline-block h-3.5 w-3.5" />
        </Link>
      </p>
    </form>
  )
