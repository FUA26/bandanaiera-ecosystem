...
import {
  useCan,
  useIsAdmin,
  usePermissionsInCategory,
} from "@/lib/rbac-client/hooks"
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-muted/50 p-4">
        ...
        <div className="grid gap-2 text-sm md:grid-cols-2">
          <div>
            <span className="font-medium">USER:</span> User management
            permissions
          </div>
          <div>
          ...
          <div>
            <span className="font-medium">SETTINGS:</span> Settings and
            configuration
          </div>
          <div>
