        ...
        {!selectedFile ? (
          ...
          <div className="space-y-3">
            <input
              ...
              className="block w-full text-sm text-gray-500 file:mt-2 file:mr-4 file:rounded-md"
              id="avatar-upload-debug"
            />
            <label
              htmlFor="avatar-upload-debug"
              className={cn(
                "flex cursor-pointer items-center gap-2 rounded-lg border-2 border-dashed px-4 py-2 transition-colors",
