...
export function SummaryCards() {
  ...
  const activePercentage =
    (activeSessions.current / activeSessions.capacity) * 100

  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
      {/* Card 1: Total Users */}
      <ChartWrapper title="Total Users" icon={Users} accentColor="primary">
      ...
      >
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Peak: {activeSessions.peak} today
          </p>
      ...
      {/* Card 3: API Requests */}
      <ChartWrapper title="API Requests (24h)" icon={Zap} accentColor="warning">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            {Math.round(
              apiRequests.reduce((sum, d) => sum + d.requests, 0) / 86400
            )}
            /sec avg
          </p>
          <div className="h-12">
