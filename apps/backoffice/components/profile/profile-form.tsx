...
export function ProfileForm({ initialData, onSuccess }: ProfileFormProps) {
  ...
  const handleAvatarSelect = async (
    ...
    try {
      ...
      form.setValue("avatarId", initialData.avatarId || undefined, {
        shouldDirty: false,
      })
      form.setValue("avatarUrl", initialData.avatarUrl || undefined, {
        shouldDirty: false,
      })
    }
  }
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
      ...
      <Field>
        ...
        <FieldError
          errors={
            form.formState.errors.bio ? [form.formState.errors.bio] : undefined
          }
        />
      </Field>
