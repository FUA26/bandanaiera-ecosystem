  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeaderWithIdentity
        ...
        description="Visual demonstration of Zilpo Admin's unique identity within the ecosystem"
        actions={
          <AppButton>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {appIdentity.defaultMetrics.map((metric) => {
              ...
              return (
                ...
                >
                  <div className="flex size-10 items-center justify-center rounded-lg bg-gradient-to-r from-primary to-secondary">
