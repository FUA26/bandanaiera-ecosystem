    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        <input
          ...
          className="w-full rounded-lg border border-input bg-background pl-10 shadow-sm focus-visible:ring-1 focus-visible:ring-ring sm:max-w-sm"
        />
    ...
    <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-500/20 dark:bg-amber-500/10">
      <div className="flex items-start gap-2">
        ...
        <div className="text-sm text-amber-800 dark:text-amber-200">
          <strong>Important:</strong> Keep your API Key secure. Don't share it
