    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="text-center">
          <Badge
            variant={userCount > 10 ? "default" : "secondary"}
            className="font-mono"
          >
            {userCount}
          </Badge>
    ...
    <div className="container mx-auto space-y-8 py-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Demonstrating sorting, filtering, pagination, row selection, and bulk
          actions
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="space-y-2 rounded-lg border p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Click column headers to sort ascending/descending. Multi-column
            sorting supported.
          </p>
        </div>
        ...
        <div className="space-y-2 rounded-lg border p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Filter by user count ranges, search by name, and toggle column
            visibility.
          </p>
        </div>
        ...
        <div className="space-y-2 rounded-lg border p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Select individual rows or all rows. Bulk actions appear when rows
            are selected.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-lg border bg-card p-6">
        <h2 className="mb-4 text-xl font-semibold">Roles Table</h2>
        <DataTable
          data={mockRoles}
          columns={columns}
          toolbar={(table) => (
