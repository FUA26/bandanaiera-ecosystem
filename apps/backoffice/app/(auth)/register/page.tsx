...
export const metadata: Metadata = {
  title: "Daftar Akun Baru - Zilpo Admin",
  description: "Buat akun baru untuk menggunakan panel admin Zilpo",
}
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-10 flex items-center gap-3">
        ...
        />
        <div>
          <h2 className="text-base leading-tight font-bold">Zilpo Admin</h2>
